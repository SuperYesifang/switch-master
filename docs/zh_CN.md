...
![switch-master](https://img.shields.io/badge/switch--master-v0.3.2-%23C50008?logo=npm)
...
`switch.onChange(listener, lazy:boolean):removeListener`

添加一个状态变化监听器到开关。`lazy`是否启用惰性监听，默认: `false`。
